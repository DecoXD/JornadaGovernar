...
/* eslint-disable */
const TestimonialsCard = ({imageSrc,content,title,videoSrc}:TestimonialCardProps) => {
  const [videoActive, setVideoActive] = useState(false)
  return (

    <article className="text-black font-montserrat max-w-[320px] flex flex-col items-center ">
      ...
      <div className="   flex flex-col rounded-lg p-4 gap-2 bg-[#f2eee9] min-h-56 items-center justify-center ">
        ...
        <div 
          ...
          <p className="font-medium text-xs text-[#6c3e04]  ">assista o depoimento</p>
        </div>  
      </div>
